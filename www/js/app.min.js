...
}), angular.module("bahnhof.controllers", []).controller("bahnhofCtrl", function($scope, $stateParams, Categories) {
    $scope.categories = Categories.all();
}).controller("HomeCtrl", function($scope, $document, Categories, Posts) {}).controller("CategoriesCtrl", function($scope, $stateParams, Categories) {
...
}).controller("PostCtrl", function($scope, $stateParams, Posts) {}).controller("HomeCategoryCtrl", function($scope, $document, Categories, Posts) {
